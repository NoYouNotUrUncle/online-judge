...
from judge.models import BlogPost, Comment, CommentLock, Contest, ContestParticipation, \
    ...
    OrganizationRequest, Problem, ProblemGroup, ProblemPointsVoteAdmin, ProblemType, Profile, Submission, Ticket
...
admin.site.register(ProblemPointsVoteAdmin, VoteAdmin)
